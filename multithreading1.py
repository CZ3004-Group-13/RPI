        ...
        while True:
            try:
                ...
                for msg in message_list:
                    ...
                    #and_msg = splitmsg[0]  #imageid
                    #splitmsg[1] #tbc
                   # splitmsg[2] #tbc

                   # self.msg_to_android_queue.put_nowait(self._formatted_(ANDROID_HEADER,splitmsg[0]))

                    
                    self.message_queue.put_nowait(self._formatted_(ALGORITHM_HEADER, msg))
        ...
        while True:
            try:
                ...
                for msg in message_list:
                    ...
                    elif msg == AlgorithmToRPi.TAKE_PICTURE: #need to change this.
                        print("in loop")

                        self.message_queue.put_nowait(self._formatted_("IMG",msg))
